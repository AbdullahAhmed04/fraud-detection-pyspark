...
3. A **custom-built Flask dashboard**, not a bare API and not an off-the-shelf widget library, designed around actual fraud-analyst workflows: review, triage, cost tradeoffs, and a feedback loop.
